...
class ProductCreateView(CreateView):
    ...
    form_class = ProductAdminsCreationForm
...
class ProductAdminView(UpdateView):
    model = Product
    ...
    @method_decorator(user_passes_test(lambda u: u.is_superuser))
    def dispatch(self, request, *args, **kwargs):
        return super(ProductAdminView, self).dispatch(request, *args, **kwargs)
...
class ProductAdminDelete(DeleteView):
    ...
    @method_decorator(user_passes_test(lambda u: u.is_superuser))
    def dispatch(self, request, *args, **kwargs):
        return super(ProductAdminDelete, self).dispatch(request, *args, **kwargs)
